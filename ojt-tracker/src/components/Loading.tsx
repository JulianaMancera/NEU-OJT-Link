import loadingLogo from '../assets/loading-logo.png'; // Adjust the path based on your project structure
    ...
    <div className="fixed inset-0 z-50 flex justify-center items-center bg-gradient-to-br from-[#1B38AC] to-[#7792FD]">
      <div className="flex items-center space-x-2">
        ...
        <img
          src={loadingLogo}
          alt="Loading Logo"
          className="w-25 h-25" // Adjust size as needed
        />
        {/* Loading Text */}
        <h1 className="text-white text-xl font-sans">Loading</h1>
        {/* Spinning Icon */}
        <div className="w-6 h-6 border-5 border-t-transparent border-white rounded-full animate-spin"></div>
      </div>
      {/* Progress Bar */}
